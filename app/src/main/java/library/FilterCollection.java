...
public class FilterCollection {
     ...
     */
    public static User filtrarUser(Set<User> users, String criteria) {
     ...
     * @param criteria o critério de filtragem
     */
    public static Emprestimo filtrarEmprestimo(Set<Emprestimo> emprestimos, String criteria) {
     ...
     * @param criteria o critério de filtragem
     */
    public static Emprestavel filtrarEmprestavel(Set<Emprestavel> emprestaveis, String criteria) {
